...
目前正式版本：M10.1
目前開發進度：M10.3.2 已完成；M14.1 Ollama Gateway 程式完成，待公司 0009／AI draft E2E
...
| M14.1 | 程式完成、待公司 E2E | 待正式 commit | 關閉 AI／App 回 m10.3.2；0009 保留 | Ollama draft、遮蔽、audit、timeout/retry、deterministic fallback |
