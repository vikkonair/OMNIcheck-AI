...
- 公司 VM 已切換 release `327748d`，per-release venv、systemd、deploy lock／owner、health、UI markers 與 `/classic` 均通過；聯詠 topology／format 修正已由正式 Discovery API 驗證，rollback release 為 `0a6dccd`。
