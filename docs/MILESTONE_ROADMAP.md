...
| M13.2 | 公司已部署、待客戶 Job 驗收 | Primary-only Product／Version Parser、確定性 matcher、fixed／pending 狀態 |
| M13.3 | 公司已部署、待客戶 Job／PDF 驗收 | V4 `version_updates`、CVE metadata gate、CVE artifact；待實機 E2E |
