...
| M11 | 公司 HTTP 測試完成、正式 TLS 驗收待辦 | feature-flag local login、scrypt password hash、HttpOnly session、CSRF、Customer membership／RBAC、legacy Job admin-only 與 audit；victor admin 實際登入、未登入 API 401 已驗證；待 TLS／強密碼／Customer membership E2E |
